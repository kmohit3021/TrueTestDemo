...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 2-Click on link ourServices - Navigate to page qcitech-solutionshome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 3-Click on link disasterRecovery - Navigate to page qcitech-solutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 4-Click on link home - Navigate to page qcitech-solutionshome.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 5-Click on link qcitechSolutionsTeam42 - Navigate to page qcitech-solutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 6-Click on link getAquote.png')

"Step 7: Complete the testing application form with necessary details"
...
WebUI.takeScreenshot(reportLocation + '/TC5/Step 8-Click on span close - Navigate to page .png')

"Step 9: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC5-Request Quote After Exploring Disaster Recovery Services_visual_checkpoint')
