...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 3-Click on link qcitechSolutionsTeam4 - Navigate to page qcitech-solutions.png')
...
WebUI.takeScreenshot(reportLocation + '/TC1/Step 4-Click on link getAquote.png')

"Step 5: Fill out and submit the testing request form with details."
...
WebUI.takeFullPageScreenshotAsCheckpoint('TC1-Request a Quote through Services Page on Qcitech Solutions_visual_checkpoint')
